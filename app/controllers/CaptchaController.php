...
class CaptchaController extends \BaseController {
     ...
     *
     */
    public $resourcesPath = 'css/CaptchaResources';
    ...
    public $colors = array(
        ...
        array( 255, 140, 0 ), //DarkOrange
        array( 128, 0, 0 ),   //Maroon
        array( 0, 128, 128 ), //Teal
        array( 0, 0, 0 )      //Black  
    );
    ...
    public function create()
    {
        ...
        $firstText = $this->getCaptchaText(  );
        $secondText = $this->getCaptchaText(  );//$this->getRandomWord( 6, $i );
    ...
    public function show(){
        $captchaURL = URL::route( 'captcha.create' );
        return View::make( 'captcha.show' )->with( 'url', $captchaURL )->render();
    }
     ...
     * @return type
     */
    function getRandomWord($length, $case=0){ 
   $word = ""; 
